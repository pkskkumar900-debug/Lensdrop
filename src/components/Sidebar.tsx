...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl border-r border-gray-200 dark:border-slate-800 flex flex-col z-40 transition-colors duration-300">
      <div className="p-6 border-b border-gray-200 dark:border-slate-800">
        <Link to="/" className="flex items-center gap-2 text-indigo-600 dark:text-indigo-400 mb-8">
